...
OMP_NUM_THREADS=3 python new_sims.py --experiment 'test' --nlev_t 30 --beam_arcmin 7 --ellmin 30 --ellmax 3000 --delta_L 150 & sleep 1
OMP_NUM_THREADS=3 python new_sims.py --experiment 'test' --nlev_t 30 --beam_arcmin 7 --ellmin 30 --ellmax 4000 --delta_L 200 & sleep 1
wait
