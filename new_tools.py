...
def kappa(ellmin,
    ...
    Ls, kappa_auto_cl = powspec(kappa, kappa, taper, 4, map_modlmap, Lmin, Lmax,
                           delta_L)
    # deflection field power spectrum
    d_cl = kappa_auto_cl/(1/4*Ls**2)
    # phi power spectrum
    phi_cl = kappa_auto_cl/(1/4*Ls**4)
    # norm
    ...
    results = {'Ls':Ls, 'kappa':kappa, 'kappa_auto_cl':kappa_auto_cl, 'd_cl':d_cl, 'phi_cl':phi_cl, 'norm':norm, 'noise_cl':noise_cl}
    return results
